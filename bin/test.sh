...
run 0 $APP -s=1 -n=30 --no-redirect-out modbat.bes.undone.CounterModel2
run 0 $APP --mode=dot --auto-labels modbat.bes.undone.CounterModel2
savemv modbat.bes.undone.CounterModel2.dot counter2.dot
